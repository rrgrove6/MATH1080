...
\huge Take-home Quiz \#11 \\ % The assignment title
\horrule{2pt} \\[0.5cm] % Thick bottom horizontal rule
}

\author{Due date:} % The due date

\date{\normalsize April 22, 2016} % A custom date
...
\begin{flushleft}
\begin{tabular}{l l}
Names: \rule{3.2in}{.01cm}  & {}\\%Table number: \rule{1in}{.01cm}\\\\
...
Section 10.3 \#'s 1,3,5,7,11,15,19,23,27,31,35,39,41,45,55,59,63\\
Section 10.4 \#'s 1,5,9,17,21,23,27,31,35,37,41,45\\
Chapter 10 Review Problems \#'s 1,5,9,17,21,23,25,33,35,37,39,41
%----------------------------------------------------------------------------------------
